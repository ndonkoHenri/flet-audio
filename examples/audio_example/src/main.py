...
def main(page: ft.Page):
    ...
    audio1 = fta.Audio(
        ...
        on_duration_changed=lambda e: print("Duration changed:", e.duration),
        on_position_changed=lambda e: print("Position changed:", e.position),
        on_state_changed=lambda e: print("State changed:", e.state),
